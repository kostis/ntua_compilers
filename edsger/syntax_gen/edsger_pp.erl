...
%%% -------------------------------------------------------------------
%%%
%%% @doc A (not so pretty) pretty-printer of Edsger programs.
%%%
%%% <p>It exports three functions:
%%%   1. pp/1, which returns an IO list of the string of a Edsger program
%%%   2. p/0, which prints a Edsger program on stdout
...
%%% call to the generator of syntactically correct Edsger programs.  This
...
-spec pp(_) -> iolist().  % XXX: define a type for Edsger abstract syntax
